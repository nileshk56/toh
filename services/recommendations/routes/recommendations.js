...
router.get('/:entityId', authMiddleware, controller.getRecommendations); // all recommendations received by logged-in user
...
router.delete('/', authMiddleware, controller.deleteRecommendation);
